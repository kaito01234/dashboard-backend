...
export class GetTableFunction extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: ResourceProps) {
    ...
    this.nodejsFunction = new nodejs.NodejsFunction(scope, `${id}-GetTableFunction`, {
      functionName: 'TemporaryEnv-GetTableFunction',
      entry: 'lambda/temporaryEnv/getTableFunction/index.ts',
      handler: 'handler',
      depsLockFilePath: 'lambda/temporaryEnv/getTableFunction/package-lock.json',
      bundling: {
        nodeModules: ['@aws-sdk/client-dynamodb', 'dayjs'],
      },
